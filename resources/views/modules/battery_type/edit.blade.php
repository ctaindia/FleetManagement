...
<div class="height-100">
    <div class="container dashboard-container">
        ...
        <div class="row mt-0">
            ...
            <form action="{{route('admin.battery-type.update')}}" method="POST" class="add-form">
                @csrf
                <input type="hidden" name="batteryTypeId" value="{{base64_encode($bt->id)}}">
                <div class="row">
                    <div class="col-lg-6 pl-0">
                        <div class="form-group">
                            <label for="field1">Name</label>
                            <input type="text" class="form-control @error('name') is-invalid @enderror" value="{{$bt->name}}" name="name" placeholder="Battery type">
                        </div>
                        @error('name')
